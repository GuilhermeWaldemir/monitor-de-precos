...
- **gunicorn** só no servidor publicado (`render.yaml`); aqui continua o `flask run`.
- **Deploy no Render**, configurado por `render.yaml` (modo demonstração ligado). Passo a passo em `docs/deploy.md`.
